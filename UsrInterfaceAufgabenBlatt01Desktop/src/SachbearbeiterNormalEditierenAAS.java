...
public class SachbearbeiterNormalEditierenAAS extends SachbearbeiterEditierenAAS {

	
	SachbearbeiterNormalEditierenK SachbearbeiterNormalEditierenK = new SachbearbeiterNormalEditierenK();
